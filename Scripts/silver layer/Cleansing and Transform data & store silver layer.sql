...
-- store procedure of Cleansing & transforming bronze layer to silver layer
...
--Data transformation and data cleansing bronze.crm_cust_info
-- Insert the data into Silver Table
